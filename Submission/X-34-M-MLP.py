...
#tailfin height
f_height = 1792.5
#chord of base aerofoils
f_ch_b = length - d_fb_x
#chord of the mid aerofoil
f_ch_m = f_height
#chord of the tip aerofoil
f_ch_t = f_height*0.4
...
App.activeDocument().Fusion.Shapes = [App.activeDocument().Shape,App.activeDocument().Loft,App.activeDocument().Loft1,]

App.ActiveDocument.recompute()
App.activeDocument().addObject("Part::MultiFuse","Fusion001")
App.activeDocument().Fusion001.Shapes = [App.activeDocument().Loft2,App.activeDocument().Sphere, App.activeDocument().Loft3, App.activeDocument().Loft5, App.activeDocument().Loft4,]

App.ActiveDocument.recompute()
App.activeDocument().addObject("Part::MultiFuse","Fusion002")
App.activeDocument().Fusion002.Shapes = [App.activeDocument().Part__Mirroring, App.activeDocument().Loft6, App.activeDocument().Loft7, App.activeDocument().Part__Mirroring001, App.activeDocument().Loft8, App.activeDocument().Loft9,]

App.ActiveDocument.recompute()
App.activeDocument().addObject("Part::MultiFuse","Fusion003")
App.activeDocument().Fusion003.Shapes = [App.activeDocument().Fusion, App.activeDocument().Fusion001, App.activeDocument().Fusion002,]
App.ActiveDocument.recompute()
...
import Part
Part.export(__objs__,u"D:/University/Year 4/Dissertation/X-34/X34gmsh_halfMLP.step")
Part.export(__objs__,u"D:/University/Year 4/Dissertation/X-34/X34gmsh_halfMLP.iges")
del __objs__
App.ActiveDocument.recompute()
...
FreeCAD.ActiveDocument.getObject("Mesh").Mesh.write("D:/University/Year 4/Dissertation/X-34/X34mesh_halfMLP.stl","STL","Fusion002 (Meshed)")
App.ActiveDocument.recompute()
