def datacall(alt,hem,lat):
    ...
    if alt >= 20:
        ...
        press_maxa1 = max_press_min1 + ((max_press_max1 - max_press_min1)*(m - press_min1))/(press_max1 - press_min1)
        ...
        press_maxa4 = max_press_min4 + ((max_press_max4 - max_press_min4)*(q - press_min4))/(press_max4 - press_min4)
        ...
        press_maxa7 = max_press_min7 + ((max_press_max7 - max_press_min7)*(t - press_min7))/(press_max7 - press_min7)
        ...
        press_maxa10 = max_press_min10 + ((max_press_max10 - max_press_min10) * (w - press_min10)) / (press_max10 - press_min10)
    ...
    print "Altitude:",alt,"km","\nLatitude:",lat,mag,'\n','-'*25,"\nTemperature:",temp,"K","\nPressure:",press,"Pa"\
        "\nDensity:",dens,"kg/m3","\nZonal Wind Speed:",wind,"m/s\n",'-'*25,'\nCOSPAR Reference Atmosphere, 1986 (Annual)'