...
GradientOfUnstructuredDataSet2 = GradientOfUnstructuredDataSet()
GradientOfUnstructuredDataSet2.ScalarArray = ['POINTS', str(sys.argv[2]) + 'Gradient']
GradientOfUnstructuredDataSet2.ResultArrayName = str(sys.argv[2]) + 'Hessian'

writer = paraview.simple.CreateWriter(str(sys.argv[3]) + str(sys.argv[2]) + 'Hessian.csv')
