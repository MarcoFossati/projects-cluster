...
if alt in range(11000, 20000):
    temp = 216.65
    print "Temperature:", temp, "K"

elif alt in range(20100, 32000):
    btmT = 216.65
    topT = 228.65
    btmA = 20100
    topA = 32200

elif alt in range(32200, 47000):
    btmT = 228.65
    topT = 270.65
    btmA = 32200
    topA = 47300
...
sound = float((1.4 * 287 * temp)**0.5)
print "Speed of Sound:", round(sound, 2), "m/s"

dyn_visc = float(((0.000001458)*temp**1.5)/(temp+110.4))
print "Dynamic Viscosity:", round(dyn_visc, 7), "Pa"