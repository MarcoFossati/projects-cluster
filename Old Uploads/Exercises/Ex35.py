...
def bear_room():
    ...
    while True:
        next = raw_input('> ')
        if next == "steal honey":
            dead("The bear doesn't like that... He bites your head off.")
...
def cuth_room():
    ...
    print "He eats fruit and throws it at people when he is no longer hungry."
    print "Do you run away from the hot mess, or do you try to dodge his fruit?"
